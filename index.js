    ...
    <div class="card-body">
      ...
      <div class="card-footer flex justify-between mt-8">
        ...
        <div class="card-detaild-btn">
          <button
            class="inline-block cursor-pointer rounded-md bg-gray-800 px-4 py-3 text-center text-sm font-semibold uppercase text-white transition duration-200 ease-in-out hover:bg-gray-900" onclick="handleModal('${
              news?._id
            }')"
          >
            Details
